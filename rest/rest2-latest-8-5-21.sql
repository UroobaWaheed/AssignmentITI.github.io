...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2021 at 11:11 PM
...
(1, 'mayo', '50.00', 'extra mayo', 'addon_1.jpg', 'Active'),
(2, 'fdfdf', '0.00', 'dfdfdf', 'addon_2.jpg', 'Active'),
(3, 'sdsds', '12.00', 'wssd', 'addon_3.jpg', 'Active');
...
--
-- Table structure for table `cr_career`
--

CREATE TABLE `cr_career` (
  `id` int(11) NOT NULL,
  ...
  `jobapply` varchar(255) NOT NULL,
  `resume` varchar(255) NOT NULL,
  `terms` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `cr_career`
--

INSERT INTO `cr_career` (`id`, `fullname`, `dob`, `birthcountry`, `birthcity`, `martial`, `gender`, `email`, `phone`, `address`, `qualification`, `experience`, `jobapply`, `resume`, `terms`) VALUES
(2, 'Noman Asif', '27/06/1991', 'Pakistan', 'Lahore', 'Single', 'male', 'izaid56@gmail.com', '03224895195', 'Lahore', 'Inter', '2', 'Restaurant General Manager', '57e411d407c1be2b55aa21456d23e869.pdf', 'accepted'),
(4, 'Noman Asif', '1991/28/22', 'Pakistan', 'Lahore', 'Single', 'male', 'rrv7895@gmail.com', '03224895195', 'lahore giulberh', 'bcsd', '5 years', 'Restaurant General Manager', '9b3d3f61ab216b9bc1eeecfc9adf8053.pdf', 'accepted'),
(5, 'E K', '12-05-1996', 'Pakistan', 'Islamabad', 'single', 'Female', 'eishak@gmail.com', '3322323232318', 'eeeeeeeeff', 'BS SE', '6 months', 'Team Member', 'a2ad09bb9eef9e40131fafe16593a633.pdf', 'accepted'),
(6, 'Noman', '2021-12-08', '31323', '125', 'single', 'male', 'sk@gmail.com', '03000440', 'sdasd', 'dasdasd', 'adasdasd', 'Team Member', '', 'accepted'),
(7, 'KJSHF', '2133-01-03', 'SKFK', 'JHJ', 'HJJ', 'male', 'sk@gmail.com', '1233', '133', '12', '1', 'Restaurant General Manager', '', 'no'),
(8, 'KJSHF', '2133-01-03', 'SKFK', 'JHJ', 'HJJ', 'male', 'sk@gmail.com', '1233', '133', '12', '1', 'Restaurant General Manager', '', 'no'),
(9, 'KJSHF', '2133-01-03', 'SKFK', 'JHJ', 'HJJ', 'male', 'sk@gmail.com', '1233', '133', '12', '1', 'Restaurant General Manager', '', 'no'),
(10, 'asdasd', '0055-02-05', 'sda', 'dasd', 'asdad', 'male', 'ssk@gmail.com', '30118', 'asdads', 'asdasd', 'asdad', 'Team Member', '5f3cd47de36fb19a3b57ee59db74f1ef.pdf', 'accepted'),
(12, 'Noman', '1999-01-01', 'Pakistan', 'lsb', 's', 'male', 'izaid57@gmail.com', '22222222222222222222222', 'eeeeee', 'iedjwewd', 'eeeeeeeee', 'Team Member', '98dd982a4e9ff207b45d371a10cd263a.pdf', 'accepted'),
(13, 'Noman', '1995-01-24', 'Pakistan', 'lsb', 's', 'male', 'izaid57@gmail.com', '12345678', 'lve', 'uirhe', 'Not a number field', 'Team Member', '068efac3431745f2cbf8ae3556f9ac74.pdf', 'accepted'),
(14, 'Noman', '1977-01-02', 'pak', 'skjdfk', 'Married', 'male', 'izaid57@gmail.com', '12334444555', 'lajror', 'dnkdn', 'jnj', 'Restaurant General Manager', '08289affc1fa5de62302c73685dad0c8.pdf', 'accepted');
...
(1, 'smtp.gmail.com', 465, 'neelimirchrestaurant@gmail.com', 'znxaxoiqyhbzrjki', '', 'webmail');
...
(1, 1, 'How to order food?', 'You can go to the homepage or the menu section to order food you like.\r\n', 'Active'),
(2, 1, 'What are the delivery charges?', 'The delivery charges are fixed that is Rs.100.\r\n', 'Active'),
(3, 1, 'How to apply for jobs?', 'You can visit the the careers section after browsing jobs from the join us page.\r\n', 'Active');
...
(1, 'Restaurant', 'Active', '2021-04-17 02:47:46', NULL);
...
--
-- Dumping data for table `cr_feedback`
--

INSERT INTO `cr_feedback` (`id`, `name`, `email`, `phone`, `message`) VALUES
(1, 'Noman', 'izaid56@gmail.com', '12233', 'o am chkninh'),
(2, 'Noman', 'izaid56@gmail.com', '12333', 'I am developing it and am giving u second feedback'),
(3, 'My Seller Shop', 'izaid57@gmail.com', '03098987788', 'Good experience'),
(4, 'ertyu', 'sdfghj@tyui.dfghj', 'aaaaaannnnnnnnnnnnnnnnnnnnn', 'sdfghu');
...
(1, 1, 'Chicken Bryani', '250.00', 1, 'item_1.jpg', 'Special CHicken Bryani', 'Active', 'Yes', 'M3K9i05Y2KCf2QOD'),
(2, 1, 'Shami Bryani', '150.00', 1, 'item_2.jpg', 'shami bryani', 'Active', 'Yes', '5TQEXof34JG59OXu'),
(3, 2, 'Burger', '100.00', 1, 'item_3.jpg', 'fast', 'Active', 'Yes', 'sxKtdvxT3LxTuCJb'),
(4, 2, 'Burger', '120.00', 2, 'item_4.jpg', 'Burger', 'Active', 'Yes', '7psDKnp0Ef18WdRq'),
(5, 1, 'Chinese Rice', '0.00', 1, 'item_5.jpg', 'Chines Rice', 'Active', 'Yes', 'Hf0wDNJLjyEoVKgG'),
(6, 3, 'Desi ChickenKarahi', '1299.00', 2, 'item_6.jpeg', 'Desi Chicken Karahi', 'Active', 'Yes', 'TWELVKUnlRRyrF5Q'),
(9, 1, 'Desi ChickenKarahi', '222.00', 2, 'item_.jpg', 'KSKFNSKFN', 'Active', 'Yes', 'v2ElGEhDq3QCOpkE'),
(10, 1, 'Desi ChickenKarahi', '1250.00', 2, 'item_10.jpg', 'ccdcdd', 'Active', 'Yes', 'Zl9dyluSzsCdNVaO'),
(11, 1, 'd', '1250.00', 2, 'item_11.jpg', 'cdfdfd', 'Active', 'Yes', '29nmmaWiYf0BKjZH');
...
(727, 'Web', 'order_cost', 'Order Amount'),
...
(1259, 'Web', '\n                            language_code_required ', '                            language code required '),
...
(1344, 'Web', 'contact_map_script', 'Contact map script'),
(1345, 'Web', 'no_item_types_available', 'No item types available'),
(1346, 'Web', 'please_prode_delivery_address', 'Please prode delivery address'),
(1347, 'Web', 'delivered_date', 'Delivered date'),
(1348, 'Web', 'resumes', 'Resumes'),
(1349, 'Web', 'file', 'File'),
(1350, 'Web', 'Resume', 'Resume'),
(1351, 'Web', 'career', 'Career'),
(1352, 'Web', 'Activation Email Sent. Please check your inbox or spam', 'Activation Email Sent. Please check your inbox or spam'),
(1353, 'Web', 'positions', 'Positions'),
(1354, 'Web', 'title', 'Title'),
(1355, 'Web', 'seats', 'Seats'),
(1356, 'Web', 'add_position', 'Add position'),
(1357, 'Web', 'edit_Positions', 'Edit Positions'),
(1358, 'Web', 'Available Positions', 'Available Positions'),
(1359, 'Web', 'Feedback', 'Feedback'),
(1360, 'Web', 'This Form Is for Feed Back Purpose', 'This Form Is for Feed Back Purpose'),
(1361, 'Web', 'Phone Number Required', 'Phone Number Required'),
(1362, 'Web', 'Give Feedback', 'Give Feedback'),
(1363, 'Web', 'feedbacks', 'Feedbacks'),
(1364, 'Web', 'hdhh', 'Hdhh'),
(1365, 'Web', 'selecjuut', 'Selecjuut'),
(1366, 'Web', 'select this', 'Select this'),
(1367, 'Web', 'Status Updated', 'Status Updated'),
(1368, 'Web', 'delivery_boy_wise_reports', 'Delivery boy wise reports'),
(1369, 'Web', 'Delivery Boy', 'Delivery Boy'),
(1370, 'Web', 'most_order_item_reports', 'Most order item reports'),
(1371, 'Web', 'no_of_times', 'No of times'),
(1372, 'Web', 'Job Responses', 'Job Responses'),
(1373, 'Web', 'No of Applications', 'No of Applications'),
(1374, 'Web', 'All Orders', 'All Orders'),
(1375, 'Web', 'Account Successfully Created', 'Account Successfully Created'),
(1376, 'Web', 'Under-Process', 'Under-Process'),
(1377, 'Web', 'total_orders', 'Total orders'),
(1378, 'Web', 'process_orders', 'Process orders'),
(1379, 'Web', 'out_deliver_orders', 'Out deliver orders'),
(1380, 'Web', 'join_us', 'Join us'),
(1381, 'Web', 'Postion Apply For', 'Postion Apply For'),
(1382, 'Web', 'Name of Applicant', 'Name of Applicant'),
(1383, 'Web', 'Total Amount', 'Total Amount');
...
(1, 'Biryani', 'Biryani', 'Spicy Chicken Biryani', 'menu_1.jpeg', 'Active'),
(2, 'Fast Food ', 'Fast Food ', 'Fast Food , Burger, shawarma salad, ', 'menu_2.jpeg', 'Active'),
(3, 'Desi khana ', 'desi khana', 'All Kind of Desi Khana Available, Desi Karahi', 'menu_3.jpg', 'Active');
...
(1, 102, '2021-04-13', '13:41 PM', '300.00', 50.00, 'Ares Rv', '123456789', '123', '23sd', 'ff', 'Gulberg', 'Lahore', 1, '54000', 'No', NULL, NULL, '', '2021-04-13 08:41:32', 'delivered', 'cash', NULL, NULL, 1, '2021-05-03', '300.00', NULL, NULL, NULL, NULL, NULL, '2021-04-13', NULL, NULL, 'Yes', 100, '2021-04-13 13:45:06', 'Yes', 'No', NULL, 101, '2021-04-13 13:45:48', 100, '2021-05-03 00:23:49', 'admin', '2021-05-03 00:23:49', NULL, NULL, NULL, NULL),
(2, 102, '2021-04-13', '16:01 PM', '300.00', 50.00, 'Ares Rv', '123456789', 'MM Alam', 'ghosia', 'MM Alam', 'Gulberg', 'Lahore', 1, '54000', 'No', NULL, NULL, 'delivery', '2021-04-13 11:01:44', 'delivered', 'cash', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-04-13', NULL, NULL, 'Yes', 100, '2021-04-13 16:12:10', 'Yes', 'No', NULL, 101, '2021-04-13 16:16:15', 101, '2021-05-03 01:45:03', 'dm', '2021-05-03 01:45:04', NULL, NULL, NULL, NULL),
(3, 102, '2021-04-13', '16:29 PM', '500.00', 50.00, 'Ares Rv', '123456789', '123', '23sd', 'ff', 'Gulberg', 'Lahore', 1, '54000', 'No', NULL, NULL, '', '2021-04-13 11:29:34', 'delivered', 'cash', NULL, NULL, 2, '2021-05-01', '500.00', NULL, NULL, NULL, NULL, NULL, '2021-04-13', NULL, NULL, 'Yes', 100, '2021-04-30 23:15:46', 'Yes', 'No', NULL, 101, '2021-05-01 00:11:49', 100, '2021-05-01 01:04:08', 'admin', '2021-05-01 01:04:08', NULL, NULL, NULL, NULL),
(4, 102, '2021-04-17', '23:17 PM', '400.00', 50.00, 'Ares Rv', '123456789', 'MM Alam', 'ghosia', 'MM Alam', 'Gulberg', 'Lahore', 1, '54000', 'No', NULL, NULL, '', '2021-04-17 18:17:30', 'delivered', 'cash', NULL, NULL, 1, '2021-05-01', '400.00', NULL, NULL, NULL, NULL, NULL, '2021-04-17', NULL, NULL, 'Yes', 100, '2021-04-18 00:45:45', 'No', 'Yes', 100, 101, '2021-04-18 00:46:10', 100, '2021-05-03 00:22:50', 'admin', '2021-05-03 00:22:50', NULL, NULL, '-77.969658', '38.199020'),
(5, 102, '2021-04-18', '16:37 PM', '550.00', 50.00, 'Ares Rv', '123456789', 'MM Alam', 'ghosia', 'MM Alam', 'Gulberg', 'Lahore', 1, '54000', 'No', NULL, NULL, '', '2021-04-18 11:37:39', 'delivered', 'cash', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-04-18', NULL, NULL, NULL, NULL, NULL, 'Yes', 'No', NULL, 101, '2021-04-18 16:38:57', 101, '2021-04-18 23:21:38', 'dm', '2021-04-18 23:21:38', NULL, NULL, '74.35043', '31.522044'),
(6, 112, '2021-05-02', '21:05 PM', '1969.00', NULL, 'admin admin', '12345678910111', '22', '1', 'near mosque', 'Darband', 'Mansehra', 3, '54000', 'No', NULL, NULL, NULL, '2021-05-02 16:05:16', 'new', 'cash', NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0'),
(7, 112, '2021-05-02', '21:06 PM', '1969.00', NULL, 'admin admin', '12345678910111', '22', '1', 'near mosque', 'Darband', 'Mansehra', 3, '54000', 'No', NULL, NULL, NULL, '2021-05-02 16:06:15', 'new', 'cash', NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0'),
(8, 112, '2021-05-02', '21:06 PM', '1969.00', NULL, 'admin admin', '12345678910111', '22', '1', 'near mosque', 'Darband', 'Mansehra', 3, '54000', 'No', NULL, NULL, NULL, '2021-05-02 16:06:52', 'new', 'cash', NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0'),
(9, 112, '2021-05-02', '21:07 PM', '1969.00', NULL, 'admin admin', '12345678910111', '22', '1', 'near mosque', 'Darband', 'Mansehra', 3, '54000', 'No', NULL, NULL, NULL, '2021-05-02 16:07:42', 'new', 'cash', NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0'),
(10, 112, '2021-05-02', '21:09 PM', '1969.00', NULL, 'admin admin', '12345678910111', '22', '1', 'near mosque', 'Darband', 'Mansehra', 3, '54000', 'No', NULL, NULL, '', '2021-05-02 16:09:26', 'out_to_deliver', 'cash', NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, 'Yes', 'No', NULL, 101, '2021-05-08 00:51:35', 100, '2021-05-08 00:51:35', NULL, NULL, NULL, NULL, '0', '0'),
(11, 112, '2021-05-02', '21:11 PM', '1969.00', NULL, 'admin admin', '12345678910111', '22', '1', 'near mosque', 'Darband', 'Mansehra', 3, '54000', 'No', NULL, NULL, '', '2021-05-02 16:11:25', 'process', 'cash', NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 100, '2021-05-08 00:39:21', NULL, NULL, NULL, NULL, '0', '0'),
(12, 102, '2021-05-02', '21:13 PM', '1820.00', 50.00, 'Ares Rv', '123456789', '22', 'lve, lovb', 'near mosque', 'Oghi', 'Mansehra', 3, '54000', 'No', NULL, NULL, '', '2021-05-02 16:13:41', 'out_to_deliver', 'cash', NULL, NULL, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, 'Yes', 'No', NULL, 101, '2021-05-08 00:48:08', 100, '2021-05-08 00:48:08', NULL, NULL, NULL, NULL, '0', '0'),
(13, 102, '2021-05-02', '22:13 PM', '300.00', 50.00, 'Ares Rv', '123456789', '22', 'lve, lovb', 'near mosque', 'Oghi', 'Mansehra', 3, '54000', 'No', NULL, NULL, '', '2021-05-02 17:13:08', 'cancelled', 'cash', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 100, '2021-05-03 01:41:48', NULL, NULL, 'admin', '2021-05-03 01:41:48', '0', '0'),
(14, 102, '2021-05-02', '22:14 PM', '300.00', 50.00, 'Ares Rv', '123456789', '22', 'lve, lovb', 'near mosque', 'Oghi', 'Mansehra', 3, '54000', 'No', NULL, NULL, 'fine', '2021-05-02 17:14:31', 'delivered', 'cash', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, 'Yes', 100, '2021-05-03 00:27:01', 'Yes', 'No', NULL, 101, '2021-05-03 00:51:08', 101, '2021-05-03 00:52:07', 'dm', '2021-05-03 00:52:08', NULL, NULL, '0', '0'),
(15, 102, '2021-05-02', '22:29 PM', '400.00', 50.00, 'Ares Rv', '123456789', '22', 'lve, lovb', 'near mosque', 'Oghi', 'Mansehra', 3, '54000', 'No', NULL, NULL, '', '2021-05-02 17:29:41', 'delivered', 'cash', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-02', NULL, NULL, 'Yes', 100, '2021-05-03 01:38:32', 'Yes', 'No', NULL, 101, '2021-05-03 01:39:25', 101, '2021-05-03 01:39:56', 'dm', '2021-05-03 01:39:57', NULL, NULL, '0', '0'),
(16, 102, '2021-05-03', '02:34 AM', '200.00', 50.00, 'Ares Rv', '123456789', '22', 'lve, lovb', 'near mosque', 'Oghi', 'Mansehra', 3, '54000', 'No', NULL, NULL, '', '2021-05-02 21:34:07', 'delivered', 'cash', NULL, NULL, 1, '2021-05-08', '200.00', NULL, NULL, NULL, NULL, NULL, '2021-05-03', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 100, '2021-05-08 00:34:34', 'admin', '2021-05-08 00:34:34', NULL, NULL, '0', '0'),
(17, 119, '2021-05-07', '23:03 PM', '1250.00', NULL, 'asafsg adafss', '78727347427', 'qrwty', 'ghosia', 'aadfdhfj', 'Darband', 'Mansehra', 3, '54000', 'No', NULL, NULL, 'delivered....................', '2021-05-07 18:03:50', 'delivered', 'cash', NULL, NULL, 1, '2021-05-08', '1250.00', NULL, NULL, NULL, NULL, NULL, '2021-05-07', NULL, NULL, NULL, NULL, NULL, 'Yes', 'No', NULL, 101, '2021-05-08 00:16:57', 100, '2021-05-08 00:18:49', 'admin', '2021-05-08 00:18:49', NULL, NULL, '0', '0');
...
(1, 6, 4, 'mayo', 'addon_1.jpg', '50.00', 1, '50.00', 72, 0),
(2, 7, 4, 'mayo', 'addon_1.jpg', '50.00', 1, '50.00', 16, 0),
(3, 8, 4, 'mayo', 'addon_1.jpg', '50.00', 1, '50.00', 64, 0),
(4, 9, 4, 'mayo', 'addon_1.jpg', '50.00', 1, '50.00', 34, 0),
(5, 10, 4, 'mayo', 'addon_1.jpg', '50.00', 1, '50.00', 18, 0),
(6, 11, 4, 'mayo', 'addon_1.jpg', '50.00', 1, '50.00', 79, 0),
(7, 12, 4, 'mayo', 'addon_1.jpg', '50.00', 1, '50.00', 54, 1);
...
(1, 0, 1, 1, 1, 'Chicken Bryani', 'item_1.jpg', '', '', '', '', '250.00', 1, '250.00', '06'),
(2, 0, 2, 1, 1, 'Chicken Bryani', 'item_1.jpg', '', '', '', '', '250.00', 1, '250.00', '56'),
(3, 0, 3, 3, 2, 'Burger', 'item_3.jpg', '', '', '', '', '300.00', 3, '100.00', '42'),
(4, 0, 3, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '68'),
(5, 0, 4, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '69'),
(6, 0, 5, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '67'),
(7, 0, 5, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '35'),
(8, 0, 6, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '84'),
(9, 0, 6, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '24'),
(10, 0, 6, 6, 3, 'Desi ChickenKarahi', 'item_6.jpg', '', '', '', '', '1299.00', 1, '1299.00', '14'),
(11, 0, 6, 4, 2, 'Burger', 'item_4.jpg', '', '', '', '', '170.00', 1, '120.00', '72'),
(12, 0, 7, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '59'),
(13, 0, 7, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '28'),
(14, 0, 7, 6, 3, 'Desi ChickenKarahi', 'item_6.jpg', '', '', '', '', '1299.00', 1, '1299.00', '02'),
(15, 0, 7, 4, 2, 'Burger', 'item_4.jpg', '', '', '', '', '170.00', 1, '120.00', '16'),
(16, 0, 8, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '75'),
(17, 0, 8, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '37'),
(18, 0, 8, 6, 3, 'Desi ChickenKarahi', 'item_6.jpg', '', '', '', '', '1299.00', 1, '1299.00', '01'),
(19, 0, 8, 4, 2, 'Burger', 'item_4.jpg', '', '', '', '', '170.00', 1, '120.00', '64'),
(20, 0, 9, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '31'),
(21, 0, 9, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '06'),
(22, 0, 9, 6, 3, 'Desi ChickenKarahi', 'item_6.jpg', '', '', '', '', '1299.00', 1, '1299.00', '47'),
(23, 0, 9, 4, 2, 'Burger', 'item_4.jpg', '', '', '', '', '170.00', 1, '120.00', '34'),
(24, 0, 10, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '90'),
(25, 0, 10, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '49'),
(26, 0, 10, 6, 3, 'Desi ChickenKarahi', 'item_6.jpg', '', '', '', '', '1299.00', 1, '1299.00', '54'),
(27, 0, 10, 4, 2, 'Burger', 'item_4.jpg', '', '', '', '', '170.00', 1, '120.00', '18'),
(28, 0, 11, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '01'),
(29, 0, 11, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '06'),
(30, 0, 11, 6, 3, 'Desi ChickenKarahi', 'item_6.jpg', '', '', '', '', '1299.00', 1, '1299.00', '63'),
(31, 0, 11, 4, 2, 'Burger', 'item_4.jpg', '', '', '', '', '170.00', 1, '120.00', '79'),
(32, 0, 12, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '32'),
(33, 0, 12, 7, 4, 'Shashlik', 'item_7.jpg', '', '', '', '', '1250.00', 1, '1250.00', '63'),
(34, 0, 12, 3, 2, 'Burger', 'item_3.jpg', '', '', '', '', '100.00', 1, '100.00', '56'),
(35, 0, 12, 4, 2, 'Burger', 'item_4.jpg', '', '', '', '', '170.00', 1, '120.00', '54'),
(36, 0, 13, 1, 1, 'Chicken Bryani', 'item_1.jpg', '', '', '', '', '250.00', 1, '250.00', '25'),
(37, 0, 14, 1, 1, 'Chicken Bryani', 'item_1.jpg', '', '', '', '', '250.00', 1, '250.00', '93'),
(38, 0, 15, 5, 1, 'Chinese Rice', 'item_5.jpg', '', '', '', '', '350.00', 1, '350.00', '87'),
(39, 0, 16, 2, 1, 'Shami Bryani', 'item_2.jpg', '', '', '', '', '150.00', 1, '150.00', '58'),
(40, 0, 17, 11, 1, 'd', 'item_11.jpg', '', '', '', '', '1250.00', 1, '1250.00', '90');
...
(1, 'production id', 'sandobx id', 'Hungry Duck', 'merchant url', 'merchant user agreement url', 'USD', 'sandbox', 'your paypal account email', 'Inactive');

-- --------------------------------------------------------

--
-- Table structure for table `cr_positions`
--

CREATE TABLE `cr_positions` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `cr_positions`
--

INSERT INTO `cr_positions` (`id`, `title`, `status`, `seats`) VALUES
(3, 'Team Member', 1, '112'),
(4, 'Restaurant General Manager', 1, '12');
...
(2, 3, 'Balakot', '54000', 50.00, '12', '12', 'minutes', 'Active'),
(3, 3, 'Oghi', '54000', 50.00, '', '', 'minutes', 'Active'),
(4, 3, 'Darband', '54000', NULL, NULL, NULL, NULL, 'Active'),
(5, 3, 'Baffa Pakhal', '54999', NULL, NULL, NULL, NULL, 'Active'),
(6, 3, 'Hilkot', '4332', NULL, NULL, NULL, NULL, 'Active');
...
(1, 'Neeli Mirch', 'RESTAURANT', 'Mansehra', 'Mansehra', 'Khayber Pakhtun Khuwan', 'Pakistan', '500081', '03224895195', '03224895195', '123456789', 'neelimirchrestaurant@gmail.com', 'US', 'Asia/Karachi', '00:00', '23:59', 'english', 'SoftTouch-Noman', '© Neeli Restaurant 2021. All Rights Reserved.', 'site_logo.png', 'second_site_logo.png', 'fevicon.ico', 'PKR', 'Rs.', '54000', '17.456294', '78.367759', '', '', '', '', 'one signal server api key', 'one signal app id', 'No', 'No', 'orange', 'd-m-Y', 'cash_on_delivery', 'pusher app id', 'pusher secret', 'KEY', 'Yes', '289885396054288', '2f70cd3498c00e26ebf8d16cf554b275', '265750248071-ns2dp45qg07j9oh5ohvl7rg7qapt2ic1.apps.googleusercontent.com', 'qusUtzN5iJwUMFMLOrmpnh4R', 'home_page_img.jpg', 'Best Quality and Tasty Food', '35 min average delivery time', '<div class=\"mapouter\"><div class=\"gmap_canvas\"><iframe width=\"600\" height=\"500\" id=\"gmap_canvas\" src=\"https://maps.google.com/maps?q=punjab%20chowk%20bus%20stop%20mansehra&t=&z=13&ie=UTF8&iwloc=&output=embed\" frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\"></iframe><a href=\"https://fmovies2.org\">fmovies</a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href=\"https://www.embedgooglemap.net\">google map on website</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div></div>');
...
(1, 'https://www.facebook.com/neeli.mirch.5', 'https://twitter.com/MirchNeeli?s=08', 'https://plus.google.com/', 'https://www.linkedin.com/uas/login', 'https://www.instagram.com/neelimirchrestaurant?r=nametag', 'https://in.pinterest.com/login/', 'https://www.tumblr.com/login');
...
INSERT INTO `cr_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `photo`, `phone`, `address`, `city`, `pincode`, `landmark`, `device_id`, `platform`, `registration_through`, `registration_type`, `referral_code`, `user_points`, `refer_by`, `refer_by_code`, `created_datetime`, `updated_datetime`, `is_activated`, `assigned_cities`, `is_available`) VALUES
(1, '127.0.0.1', 'Admin istrator', '$2y$08$eDDNaMEiW94nqH4Qw/K4puYNvibPO8OaIhUJWewbZWMJBHOHHtIri', '', 'admin@admin.com', NULL, 'B0whGSIVG-1Tr4MlqANqk.dcdc780ffa99d0633c', 1498553784, NULL, 1268889823, 1620419160, 1, 'Admin', 'istrator', 'user_1.png', '1234567890', '2009-12-24', '', '123456', '', '', '', NULL, NULL, '', 0, NULL, NULL, NULL, '2016-06-07 00:00:00', 'No', NULL, 0),
...
(100, '::1', 'Kitchen Manager', '$2y$08$eDDNaMEiW94nqH4Qw/K4puYNvibPO8OaIhUJWewbZWMJBHOHHtIri', NULL, 'kitchenmanager@gmail.com', '5637fbba7abc2454e4fe3ae312fc3d5b15d8c887', NULL, NULL, NULL, 1508936262, 1620416630, 1, 'Kitchen', 'Manager', NULL, '1234567897', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', NULL, 0, NULL, NULL, '2017-10-25 04:57:42', NULL, 'No', NULL, 0),
(101, '::1', 'Delivery Manager', '$2y$08$eDDNaMEiW94nqH4Qw/K4puYNvibPO8OaIhUJWewbZWMJBHOHHtIri', NULL, 'deliverymanager@gmail.com', '007ab7a2c34c82699cff9bb64877179358d8b98a', NULL, NULL, NULL, 1508936335, 1620416560, 1, 'Delivery', 'Manager', NULL, '1234567896', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', NULL, 0, NULL, NULL, '2017-10-25 04:58:55', NULL, 'No', '3', 1),
(102, '127.0.0.1', 'Ares Rv', '$2y$08$PLiM4aehhxnRT3/eRwxJ3.RpYy/PSMGU5rsnEhawe0JmlyLs.sbRe', '', 'rrv7895@gmail.com', '1573329dcb74d02005e324f56478a7a4678c3e0f', '', 0, '', 1618300163, 1620327518, 1, 'Ares', 'Rv', 'user_102.png', '123456789', '', '', '', '', '', '', 'portal', 'normal', 'OIVdONoIDl', 0, 0, '', '2021-04-13 12:49:23', '0000-00-00 00:00:00', 'No', '', 0),
(112, '::1', 'admin admin', '$2y$08$Re/zWYn69Oh2eiI7K.Jde.nSsgOD.Lvil9e/b.voDQ61GQXZebJay', NULL, 'admin@gmail.com', NULL, NULL, NULL, NULL, 1619971424, 1619971443, 1, 'admin', 'admin', NULL, '12345678910111', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', 'RG0ZLOjL75', 0, NULL, NULL, '2021-05-02 21:03:44', NULL, 'No', NULL, 0),
(113, '::1', 'kitchen staff kitchen 2', '$2y$08$eDDNaMEiW94nqH4Qw/K4puYNvibPO8OaIhUJWewbZWMJBHOHHtIri', NULL, 'kitchenamanager2@gmail.com', NULL, NULL, NULL, NULL, 1619975349, 1619977579, 1, 'kitchen staff', 'kitchen 2', NULL, '12345678', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', NULL, 0, NULL, NULL, '2021-05-02 22:09:09', NULL, 'No', NULL, 0),
(114, '::1', 'm m', '$2y$08$zd7ZSWcSfAlGeFoNSUKZnuszQREsEeLRJOAgaI.YnPwOXZeZx1E4u', NULL, 'nayyab.bsse3448@iiu.edu.pk', NULL, NULL, NULL, NULL, 1619986881, 1619986894, 1, 'm', 'm', NULL, '12345678', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', 'boH6PpqA1P', 0, NULL, NULL, '2021-05-03 01:21:21', NULL, 'No', NULL, 0),
(117, '::1', 'dsds ddff', '$2y$08$iNqV7UxUi7rGIzt5OtRToulVV73KoIzgSC9JQ37XK//uREeQzrz22', NULL, 'adsadsadsadd@gmail.com', NULL, NULL, NULL, NULL, 1620335611, NULL, 0, 'dsds', 'ddff', NULL, 'fdsfsd332', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', NULL, 0, NULL, NULL, '2021-05-07 02:13:31', NULL, 'No', NULL, 0),
(118, '::1', 'DB 3', '$2y$08$DX6uBAxjZtq0x/tAZvuOuukQyCjkDzutqr2pIIFZvC8RfKCbXgdLm', NULL, 'db3@gmail.com', NULL, NULL, NULL, NULL, 1620336229, NULL, 1, 'DB', '3', NULL, '89898888999', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', NULL, 0, NULL, NULL, '2021-05-07 02:23:49', NULL, 'No', '3', 0),
(119, '127.0.0.1', 'asafsg adafss', '$2y$08$2Hl8oKNVs5XrwDYTgooXOuddP/p2ENrk2Gh0.1s2KToncPBqWL9mS', NULL, 'khannayyab25@gmail.com', NULL, 'Gux95-G2.O2CH0kzRMNhDO6a96fae7477b1f24ea', 1620413107, NULL, 1620410540, 1620418909, 1, 'asafsg', 'adafss', NULL, '78727347427', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'normal', 'XoK4sbxAQC', 0, NULL, NULL, '2021-05-07 23:02:20', NULL, 'No', NULL, 0),
(120, '127.0.0.1', ' ', '$2y$08$tz3IUrHeDaNZ08RJ5lWcZu9BU2Itlr/EIKavUfoSFAdaqrKTgFBAu', NULL, 'neelimirchrestaurant@gmail.com', NULL, NULL, NULL, 'x65YpCqegX/pkyG0Q30Glu', 1620412973, 1620412973, 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, 'portal', 'google', 'mQ9DZGx473', 0, NULL, NULL, '2021-05-07 23:42:53', NULL, 'No', NULL, 0);
...
INSERT INTO `cr_user_address` (`ua_id`, `user_id`, `house_no`, `street`, `landmark`, `pincode`, `locality`, `city`, `is_default`, `location_id`, `ipAdd`) VALUES
(1, 102, '123', '23sd', 'ff', '54000', 'Gulberg', 'Lahore', NULL, 1, NULL),
(2, 102, 'MM Alam', 'ghosia', 'MM Alam', '54000', 'Gulberg', 'Lahore', NULL, 1, NULL),
(3, 112, '22', '1', 'near mosque', '54000', 'Darband', 'Mansehra', NULL, 4, NULL),
(4, 102, '22', 'lve, lovb', 'near mosque', '54000', 'Oghi', 'Mansehra', NULL, 3, NULL),
(5, 114, '22', '11', 'near mosque', '54000', 'Oghi', 'Mansehra', NULL, 3, NULL),
(6, 119, 'qrwty', 'ghosia', 'aadfdhfj', '54000', 'Darband', 'Mansehra', NULL, 4, NULL);
...
--
-- Indexes for table `cr_career`
--
ALTER TABLE `cr_career`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cr_feedback`
--
ALTER TABLE `cr_feedback`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `cr_positions`
--
ALTER TABLE `cr_positions`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cr_career`
--
ALTER TABLE `cr_career`
...
--
-- AUTO_INCREMENT for table `cr_feedback`
--
ALTER TABLE `cr_feedback`
...
--
ALTER TABLE `cr_item_addons`
  MODIFY `item_addon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `cr_languagewords`
  MODIFY `lang_id` bigint(22) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1384;
...
--
-- AUTO_INCREMENT for table `cr_positions`
--
ALTER TABLE `cr_positions`
...
--
ALTER TABLE `cr_service_provide_locations`
  MODIFY `service_provide_location_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

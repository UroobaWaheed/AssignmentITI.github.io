...
***/
    ...
    function ajax_get_list()
    {
        if ($this->input->is_ajax_request()) {
            ...
            $query     = "SELECT CONCAT(tds.first_name,' ',tds.last_name) as username,tds.email,tds.id,tds.phone,tds.active,tds.photo from ".TBL_PREFIX.TBL_USERS." tds INNER JOIN ".TBL_PREFIX.TBL_USERS_GROUPS." ug on tds.id=ug.user_id WHERE ug.group_id=2";

<div id="page-wrapper">
            ...
            <div class="row">
			<!-- <a title="<?php echo get_languageword('add_record'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_ADDEDIT_KITCHEN_MANAGER;?>"><i class="fa fa-plus"></i>Add Available Positions</a> -->
                <div class="col-md-12">
			...
			<table id="example" class="display responsive nowrap" width="100%" cellspacing="0">
			  	...
			  	<thead>
					...
					<tr>
						...
						<th><?php echo get_languageword('Postion Apply For');?></th>

						<th><?php echo get_languageword('phone');?></th>

						<th><?php echo get_languageword('Resume');?></th>

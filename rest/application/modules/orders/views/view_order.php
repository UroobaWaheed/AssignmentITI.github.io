  			...
  			<div class="panel panel-default">
  				...
  				<div class="panel-heading">
  					<?php if (isset($pagetitle)) echo $pagetitle;
						...
						?>
  					<a title="Print" style="margin-left:10px" class="btn btn-info btn-xs pull-right" href="#" onclick="printit()"><i  class="fa fa-print"></i>
  					Print Order</a>
  				...
  				<div class="panel-body printableonly" id="printableonly">
  					...
  					<div class="row mainscreen">
  						...
  						<?php if (isset($order) && ($order->status != 'cancelled' && $order->status != 'delivered') && getUserType() == 'kitchen_manager') { ?>
  							...
  							<tr>
  								<td width="50%">
  									<table width="100%">
  										...
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('order_no'); ?>:</span><?php if (isset($order->order_id)) echo $order->order_id; ?></td>
  										</tr>



  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('order_date'); ?>:</span><?php if (isset($order->order_date) && $order->order_date != '') echo get_date($order->order_date); ?></td>
  										</tr>

  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('order_time'); ?>:</span> <?php if (isset($order->order_time) && $order->order_time != '') echo $order->order_time; ?></td>
  										</tr>
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('delivery_cost'); ?>:</span><?php if (isset($order->delivery_fee)) echo $currency . $order->delivery_fee; ?></td>
  										</tr>
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('order_cost'); ?>:</span><?php if (isset($order->total_cost)) echo $currency . ($order->total_cost - $order->delivery_fee); ?></td>
  										</tr>
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('paid_amount'); ?>:</span><?php if (isset($order->paid_amount)) echo $currency . $order->paid_amount; ?></td>
  										</tr>
  										<?php if ($order->is_points_redeemed == 'Yes') { ?>

  											<tr>
  												<td colspan="2"><span><?php echo get_languageword('no_of_points_redeemed'); ?>:</span><?php if (isset($order->no_of_points_redeemed)) echo $order->no_of_points_redeemed; ?></td>
  											</tr>
  											<tr>
  												<td colspan="2"><span><?php echo get_languageword('points_value'); ?>:</span><?php if (isset($order->points_value)) echo $currency . $order->points_value; ?></td>
  											</tr>

  										<?php } ?>
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('booked_date'); ?>:</span><?php if (isset($order->date_created)) echo $order->date_created; ?></td>
  										</tr>
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('status'); ?>:</span><?php if (isset($order->status)) echo ucwords(str_replace('_', ' ', $order->status)); ?></td>
  										</tr>
  								...
  								<td width="50%">
  									...
  									<table width="100%">
  										...
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('customer_name'); ?>:</span><?php if (isset($order->customer_name)) echo $order->customer_name; ?></td>
  										</tr>
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('phone'); ?>:</span> <?php if (isset($order->phone)) echo $order->phone; ?></td>
  										</tr>
  										<tr>
  											<td colspan="2"></td>
  										</tr>
  										...
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('house_number'); ?>:</span> <?php if (isset($order->house_no)) echo $order->house_no; ?></td>
  										</tr>


  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('street'); ?>:</span> <?php if (isset($order->street)) echo $order->street; ?></td>
  										</tr>
  										...
  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('landmark'); ?>:</span> <?php if (isset($order->landmark)) echo $order->landmark; ?></td>
  										</tr>



  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('locality'); ?>:</span> <?php if (isset($order->locality)) echo $order->locality; ?></td>
  										</tr>


  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('city'); ?>:</span> <?php if (isset($order->city)) echo $order->city; ?></td>
  										</tr>


  										<tr>
  											<td colspan="2"><span><?php echo get_languageword('zipcode'); ?>:</span> <?php if (isset($order->pincode)) echo $order->pincode; ?></td>
  										</tr>
  										...
  										<?php if ($order->is_admin_sent_to_km == 'Yes') { ?>
  											...
  											<tr>
  												<td colspan="2"><span><?php echo get_languageword('kitchen_manager'); ?>:</span> <?php if (isset($order->kitchen_manager)) echo $order->kitchen_manager; ?></td>
  											</tr>
  										...
  										<?php if ($order->dm_id > 0) { ?>
  											...
  											<tr>
  												<td colspan="2"><span><?php echo get_languageword('delivery_manager'); ?>:</span> <?php if (isset($order->delivery_manager)) echo $order->delivery_manager; ?></td>
  											</tr>
  						...
  						<table cellspacing="10" width="100%" id="example" class="display responsive nowrap" border="1">
  							<thead>
  								<tr>
  									...
  									<th><?php echo get_languageword('Total Amount'); ?></th>
  									<!-- <th><?php echo get_languageword('is_deleted'); ?></th> -->
  									<?php if ($count > 1 && ($order->status == 'new' || $order->status == 'process') && getUserType() == 'kitchen_manager') { ?>
  									...
  									<?php
										...
										foreach ($order_products as $product) :
  										...
  										<tr>
  											...
  											<!-- <td><?php if ($product->is_deleted == 0) echo get_languageword('no');
													else if ($product->is_deleted == 1) echo get_languageword('yes'); ?></td> -->
  											<?php if ($count > 1 && ($order->status == 'new' || $order->status == 'process') && getUserType() == 'kitchen_manager') { ?>
  												<td>
  										...
  										<?php
											...
											foreach ($order_addons as $addon) :
  											...
  											<tr>
  												...
  												<td><?php if ($addon->is_deleted == 0) echo get_languageword('no');
														else if ($addon->is_deleted == 1) echo get_languageword('yes'); ?></td> <?php if ($order->status == 'new' || $order->status == 'process') { ?>
  													<td>
  									...
  									<tbody>
  										<?php
  											...
  											<tr>
  												...
  												<td><?php if ($offer->is_deleted == 0) echo get_languageword('no');
														else if ($offer->is_deleted == 1) echo get_languageword('yes'); ?></td>
  												<?php if ($count > 1 && ($order->status == 'new' || $order->status == 'process')) { ?>
  													<td>

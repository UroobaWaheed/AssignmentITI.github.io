...
class Kitchen_manager extends MY_Controller
{
    ...
    function index()
    {
        ...
        $counts = array();
        $counts['total'] = $this->kitchen_manager_model->get_orders_count();
        $counts['new'] = $this->kitchen_manager_model->get_orders_count_status('new');
        $counts['process'] = $this->kitchen_manager_model->get_orders_count_status('process');
        $counts['out_deliver'] = $this->kitchen_manager_model->get_orders_count_status('out_to_deliver');
        $counts['delivered'] = $this->kitchen_manager_model->get_orders_count_status('delivered');
        $counts['cancelled'] = $this->kitchen_manager_model->get_orders_count_status('cancelled');
        $this->data['orders_count'] = $counts;

<div class="container pt-8 pb-8">
   ...
   <div class="row" >
      <div class="col-sm-3 hidden-xs">
        ...
        <div class="search cs-searchbox mb-2" >
          <div class="search-innerwrapper">
              <input type="text" id="search-inp" name="search-inp" placeholder="<?php echo get_languageword('search');?>" onkeyup="search_item();"><i class="pe-7s-search"></i>
			...
			?>
              ...
              <a href="javascript:void(0);" class=" h4 list-group-item <?php echo $clas;?>" onclick="get_menu_items_block('<?php echo $menu->menu_id;?>','<?php echo $menu->menu_name;?>')" id="<?php echo $menu->menu_id;?>"><?php echo $menu->menu_name;?></a>
			   
			<?php } } ?>   
            
			
			
			<!-- <a href="javascript:void(0);" class="list-group-item" onclick="get_offers_block()" id="offers"><?php echo get_languageword('offers');?></a> -->
			
			<a href="javascript:void(0);" class="list-group-item h4" onclick="get_popular_items_block()" id="popular_items"><?php echo get_languageword('popular_items');?></a>
	  ...
	  <!--ITEMS DIV-->
      <div class="col-sm-6 items-block shadow">

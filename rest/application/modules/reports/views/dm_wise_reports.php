				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-12 reports clearfix">
							...
							echo form_open(URL_REPORTS_DM_WISE, $attributes); ?>



							<div class="form-group col-md-3">
								<label><?php echo get_languageword('Delivery Boy') . required_symbol(); ?></label>
								<?php
								$val = '';
										...
										<tbody>
											...
											foreach ($records as $r) :
												...
												<tr>
													...
													<td><?php if (isset($r->status)) echo ucwords(str_replace("_", " ", $r->status)); ?></td>

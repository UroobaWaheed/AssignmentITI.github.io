		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<?php if (!empty($pagetitle)) echo $pagetitle; ?> <a title="Print" class="btn btn-primary btn-xs pull-right" href="#" onclick="printit()"><i class="fa fa-print"></i>
					</a>
					...
					<div class="table-responsive">
						<div id="printableonly">
							<div class="row printscreen" style="padding:40px" style="display:none">
								<center>
									<h1><?= $this->config->item('site_settings')->site_title ?></h1>
										...
										<tbody>
											...
											foreach ($records as $r) :
												...
												<tr>
													...
													<td><?php if (isset($r->payment_type)) echo $r->payment_type;
														if (!empty($r->payment_gateway)) echo ' - ' . $r->payment_gateway; ?></td>

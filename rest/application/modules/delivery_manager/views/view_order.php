				...
				<?php echo $this->session->flashdata('message'); ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							...
							<a title="<?php echo get_languageword('go_to_list'); ?>" class="btn btn-primary btn-xs pull-right" href="<?php echo URL_DM_ORDERS;?>"><i class="fa fa-list"></i>
							</a>
                        </div>
                       ...
                       <div class="col-md-6">
						...
						<li><span><?php echo get_languageword('Total Amount');?>:</span><?php if(isset($order->total_cost)) echo $currency.($order->total_cost - $order->delivery_fee);?></li>
					...
					<?php } ?>	
					 ...
					 <!-- <?php  if(empty($order->latitude) || $order->latitude=="0" || empty($order->longitude)){
						 $order->latitude = '34.3313';
						 $order->longitude = '73.1980'; 
						 }?> -->

					 <?php  if(!empty($order->latitude) && $order->latitude!="0" && !empty($order->longitude)){?>
			<div >
				<div class="text-center w-100">
				<a style="margin:15px" class="btn bg-primary btn-lg text-center" href="https://maps.google.com/?q=<?=$order->latitude?>,<?=$order->longitude?>" target="_blank"><img style="height:30px" src="https://img.icons8.com/cotton/64/26e07f/route.png"/>Navigate</a>
				</div>
				<div id="map" style="width:100%;height:400px;background:grey"></div> 
				<script>  
function myMap() {  
var mapOptions = {  
    center: new google.maps.LatLng(parseFloat(<?=$order->latitude?>), parseFloat(<?=$order->longitude?>)),  
    zoom: 18,  
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCwcRCfZye7qT5Y4i4-t8vMVE-tzXByeUk&callback=myMap"></script>   
				</div>
				<?php 
			}?>

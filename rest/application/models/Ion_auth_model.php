...
class Ion_auth_model extends CI_Model
{
    ...
    | -----------------------------------------------------
    |
    | MODULE:           ION AUTH MODEL
    | -----------------------------------------------------
    | This is ION AUTH MODEL file.
    | -----------------------------------------------------
     **/
	public function __construct()
	{
		...
		$this->display_name = $this->config->item('display_name', 'ion_auth');		
	 ...
	 * @param  boolean $salt              [description]
	 * @param  boolean $use_sha1_override [description]
	...
	/**
	 * [clear_forgotten_password_code description]
	...
	public function reset_password($identity, $new) 
 {
	...
	public function change_password($identity, $old, $new)
	{
		...
		{
		$this->set_error(get_languageword('old_password_is_wrong'));	
		}
		return FALSE;
	}
	...
	*/
	 ...
	 * @param  boolean $fb              [description]
	 * @return [type]                   [description]
	 */
	public function register($identity, $password, $email, $additional_data = array(), $groups = array(),$fb=FALSE)
	{
	...
	function add_points_to_user($user_id)
	{
		...
		if(!empty($point_settings) && $point_settings->points_enabled=='Yes' && $point_settings->reward_points_for_account_signup > 0) 
		{
			...
			$data['description']		= 'Points for Registration';
			...
			if($this->base_model->insert_operation($data, TBL_USER_POINTS))
			{
				unset($data);
				$data = array();
				$data['user_points'] = $point_settings->reward_points_for_account_signup;
	...
	public function increase_login_attempts($identity) 
 {
	...
	/**
	 * [clear_login_attempts description]
	 * @param  [type]  $identity                   [description]
	 * @param  integer $old_attempts_expire_period [description]
	 * @param  [type]  $ip_address                 [description]
	 * @return [type]                              [description]
	 */
	public function clear_login_attempts($identity, $old_attempts_expire_period = 86400, $ip_address = NULL) 
 {
	...
	/**
	 * [remove_from_group description]
	 * @param  boolean $group_ids [description]
	 * @param  boolean $user_id   [description]
	 * @return [type]             [description]
	 */
	...
	/**
	 * [login_remembered_user description]
	 * @return [type] [description]
	 */
	 ...
	 * @param  boolean $group_name        [description]
	 * @param  string  $group_description [description]
	 * @param  array   $additional_data   [description]
	 * @return [type]                     [description]
	 */
	...
	/**
	 * [set_message_delimiters description]
	 * @param [type] $start_delimiter [description]
	 * @param [type] $end_delimiter   [description]
	 * @return [type] [<description>]
	 */
	...
	/**
	 * [set_error_delimiters description]
	 * @param [type] $start_delimiter [description]
	 * @param [type] $end_delimiter   [description]
	 * @return [description]
	 */
	...
	/**
	 * [messages_array description]
	 * @param  boolean $langify [description]
	 * @return [type]           [description]
	 */
	...
	protected function _prepare_ip($ip_address) 
 {
	...
	/**
	 * [get_group_module description]
	 * @param  [type] $module [description]
	 * @param  [type] $group  [description]
	 * @return [type]         [description]
	 */
	protected function get_group_module($module, $group)
	{
		$query = 'select * from '.$this->db->dbprefix(TBL_GROUPS).' g inner join '.$this->db->dbprefix(TBL_GROUPS_MODULES).' gm ON g.id = gm.group_id WHERE gm.class_name = "'.$module.'" AND name = "'.$group.'"';

...
<div class="main-wrapper">
        <div  class="ct-banner-image primary-navbar">
        <div class="bg-light" style="background-color:white;">
            
        <nav class="nav navbar navbar-dropdown navbar-fixed-top navbar-expand-lg bg-light" style="background-color:#FAFAFA;box-shadow:2px 5px 8px black;">
                <div class="container">
                    <div class="row">
                        <div class="ct-logo">
                         ...
                         <div class="ct-navbar">
                           ...
                           <div class="navbar-offcanvas navbar-offcanvas-touch navbar-right" id="ct-bootstrap-offcanvas">
                              <ul class="nav navbar-nav ct-list ">
                                  <li><a style="color: rgb(34, 165, 229);" class="" href="<?php echo SITEURL;?>"><h4><strong>HOME</strong></h4></a></li>
                                  <li ><a style="color: rgb(34, 165, 229);" href="<?php echo URL_MENU;?>"><h4><strong>MENU</strong></h4></a></li>
                                  <li class="nav-item"><a style="color: rgb(34, 165, 229);" class="nav-link link text-primary display-4" href="<?php echo base_url();?>career"><h4><strong>CAREERS</strong></h4></a></li>
                                   <li class="nav-item"><a style="color: rgb(34, 165, 229);" class="nav-link link text-primary display-4" href="<?php echo URL_ABOUT_US;?>"><h4><strong>ABOUT US</strong></h4></a></li>
                  
								<?php if (!$this->ion_auth->logged_in()):
								$login_popup='login';
								?>
              <li><a style="color: rgb(34, 165, 229);" class="" href="javascript:void(0);" onclick="show_popup('<?php echo $login_popup;?>')"><h4><strong><i class="fa fa-user" aria-hidden="true"></i></strong></h4>
</a></li>
							  ...
							  <?php endif;?>
                                  ...
                                  <li class="hidden-xs">
                                <a style="color: rgb(34, 165, 229);" class="nav-cart" href="<?php echo URL_CART_INDEX;?>"><h4><strong><span><i class="fa fa-shopping-cart" aria-hidden="true"></i><span id="items_cnt" class="fc-count"><?php echo count($this->cart->contents());?></span></strong></h4></span> </a>
                              </li>
                              </ul>
                            </div>
                           </div>

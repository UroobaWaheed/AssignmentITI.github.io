...
A taste of home where we prioritize what you need to get you on your way. We strive to keep you at your best, and we remain loyal to you, your tastes and your time.</p>
        ...
        <?php } ?>
            ...
            <div class="col-lg-<?php echo $clg; ?> col-md-<?php echo $clg; ?> col-sm-6 col-xs-6">
                ...
                <h4 class="footer-head" style="font-size:24px;">Got To Know Us</h4>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="ct-social" style="margin-top:50px;margin-left:40px">
                ...
                <a href="<?php echo $this->config->item('social_networks')->twitter;?>" target="_blank"><i class="fa fa-twitter" style="color:white;font-size:30px;" aria-hidden="true"></i></a>
                <?php } if(isset($this->config->item('social_networks')->instagram) && $this->config->item('social_networks')->instagram != '') {?>
                <a href="<?php echo $this->config->item('social_networks')->instagram;?>" target="_blank"><i class="fa fa-instagram" style="color:white;font-size:30px;" aria-hidden="true"></i></a>
    ...
    <!-- Accepted cards end -->
      <section class="ct-subfoot" style="text-align:cente;background-color:dark-gray;color:white;">
        <div class="container" style="text-align:cente;">
            <div class="row" >
                <div class="col-sm-12 text-center" >
                    <div class=""><?php if(isset($this->config->item('site_settings')->rights_reserved_content)) echo $this->config->item('site_settings')->rights_reserved_content;?>&nbsp;</div>
                </div>

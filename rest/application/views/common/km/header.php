...
<head>
    ...
    <?php if ($this->config->item('site_settings')->admin_css == 'orange') { ?>
        ...
        <!-- MORRIS CHART STYLES-->
        <!--link href="<?php //echo CSS_ADMIN_OR_MORRIS;
                        ?>" rel="stylesheet" /-->
        <!-- CUSTOM STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo SITEURL; ?>"><img src="<?php echo get_second_site_logo(); ?>" style="height:3.5rem;" alt="logo" class="img-responsive" /></a>
            </div>

    ...
    <div id="wrapper">
         <nav class="navbar navbar-default navbar-cls-top navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a  class="navbar-brand" href="<?php echo SITEURL;?>"><img style="height:3.5rem;" src="<?php echo get_second_site_logo();?>"  alt="logo" class="img-responsive"/></a> 
            </div>
             ...
             <ul class="nav navbar-nav navbar-right">
				  ...
				  <a href="#" class="dropdown-toggle avatar crunch-profile-log" data-toggle="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						<li class="m_2"><a href="<?php echo URL_DM_PROFILE;?>"><i class="fa fa-user"></i><?php echo get_languageword('profile');?></a></li>
						
						<li class="m_2"><a href="<?php echo URL_DM_CHANGE_PASSWORD;?>"><i class="fa fa-lock"></i> <?php echo get_languageword('change_password');?> </a></li>

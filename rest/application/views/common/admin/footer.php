 ...
 <!--script src="<?php //echo JS_ADMIN_MIRROR_RAPHAEL;
					?>"></script>
    <script src="<?php //echo JS_ADMIN_MIRROR_MIRROR;
					?>"></script-->

 <!-- CUSTOM SCRIPTS -->
 <!--script src="<?php //echo JS_ADMIN_CUSTOM;
					?>"></script-->
 	...
 	<script type="text/javascript" language="javascript" class="init">
 		$(document).ready(function() {
 			<?php if (!empty($ajaxrequest["url"])) { ?>
 				get_tableData('example', '<?php echo $ajaxrequest["url"]; ?>', '<?php if (!empty($ajaxrequest["conditions"])) echo $ajaxrequest["conditions"]; ?>', '<?php if (!empty($ajaxrequest["disablesorting"])) echo $ajaxrequest["disablesorting"]; ?>', [
 					[0, "desc"]
 				], '<?php if (!empty($ajaxrequest["type"])) echo $ajaxrequest["type"]; ?>');
 			<?php } else { ?>
 				var table = '';
 				try {

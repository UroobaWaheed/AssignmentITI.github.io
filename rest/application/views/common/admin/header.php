...
<body>
    <div id="wrapper">
         ...
         <nav class="navbar navbar-default navbar-cls-top navbar-fixed-top" role="navigation" style="margin-bottom: 0">
         	...
         	<a class="navbar-brand" href="<?php echo SITEURL;?>"><img src="<?php echo get_second_site_logo();?>" style="height: 3.2rem;" alt="logo" class="img-responsive"/></a> 
			 <span class=""><a style="color: rgb(34, 165, 229);" class="h5" href="<?php echo SITEURL;?>">NEELI MIRCH</a></span>
		    <button style="margin-top:18px" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation" style="display: none;">

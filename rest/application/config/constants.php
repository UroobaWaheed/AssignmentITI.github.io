...
define('URL_REPORTS_DM_WISE', SITEURL . 'reports' . DS . 'delivery-boy-wise-reports');
...
define('URL_REPORTS_ITEM_MOST', SITEURL . 'reports' . DS . 'most-order-item-reports');
define('URL_REPORTS_JOB_RESPONSE', SITEURL . 'reports' . DS . 'job-response-reports');

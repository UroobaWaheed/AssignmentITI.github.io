...
$config['sess_cookie_name'] = 'ci_session';//'cisession';
$config['sess_expiration'] = 7200;
$config['sess_save_path'] = APPPATH.'cache/';//sys_get_temp_dir();//NULL;//APPPATH.'cache/';
// $config['sess_save_path'] = 'cr_sessions';
...
$csrf_pages = array('service', 'cart/order_success', 'cart/paypal_cancel');
